...
public class WeChatPayCallBackService {
    ...
    public HashMap<String, String> dealwithWeixinPay(HttpServletRequest request, HttpServletResponse response,
        ...
        if (Objects.equals(orderType, OrderType.GOODS.getName())) {
            return goodsOrder(response, outTradeNo, appCallBackVo);
        } else {
            return chargeOrder(response, outTradeNo, appCallBackVo);
        }
    }

    public HashMap<String, String> chargeOrder(HttpServletResponse response, String outTradeNo, Transaction appCallBackVo) {
    ...
    public HashMap<String, String> goodsOrder(HttpServletResponse response, String outTradeNo, Transaction appCallBackVo) {
