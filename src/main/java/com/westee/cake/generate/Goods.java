...
public class Goods implements Serializable {
     ...
     * @mbg.generated Tue Aug 01 22:05:43 CST 2023
     */
    public Goods(Long id, Long categoryId, String name, String description, String imgUrl, BigDecimal price, BigDecimal vipPrice, Long shopId, Integer stock, String status, Date createdAt, Date updatedAt) {
        this.id = id;
     ...
     * @mbg.generated Tue Aug 01 22:05:43 CST 2023
     */
    public Goods(Long id, Long categoryId, String name, String description, String imgUrl, BigDecimal price, BigDecimal vipPrice, Long shopId, Integer stock, String status, Date createdAt, Date updatedAt, String details) {
        this.id = id;
        this.categoryId = categoryId;
        this.name = name;
        this.description = description;
