...
public class Goods implements Serializable {
     ...
     * @mbg.generated Thu May 25 17:00:36 CST 2023
     */
    public Goods(Long id, Long categoryId, String name, String description, String imgUrl, BigDecimal price, BigDecimal vipPrice, Integer stock, String status, Date createdAt, Date updatedAt, Long shopId) {
        this.id = id;
     ...
     * @mbg.generated Thu May 25 17:00:36 CST 2023
     */
    public Goods(Long id, Long categoryId, String name, String description, String imgUrl, BigDecimal price, BigDecimal vipPrice, Integer stock, String status, Date createdAt, Date updatedAt, Long shopId, String details) {
        this.id = id;
        this.categoryId = categoryId;
        this.name = name;
        this.description = description;
