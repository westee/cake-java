...
public class Goods implements Serializable {
     ...
     * @mbg.generated Wed Dec 06 14:12:31 CST 2023
     */
    public Goods(Long id, Long categoryId, String name, String description, String imgUrl, BigDecimal price, BigDecimal vipPrice, Long shopId, Integer stock, String status, LocalDateTime createdAt, LocalDateTime updatedAt, Integer weight, Integer goodsType) {
        this.id = id;
     ...
     * @mbg.generated Wed Dec 06 14:12:31 CST 2023
     */
    public Goods(Long id, Long categoryId, String name, String description, String imgUrl, BigDecimal price, BigDecimal vipPrice, Long shopId, Integer stock, String status, LocalDateTime createdAt, LocalDateTime updatedAt, Integer weight, Integer goodsType, String details) {
        this.id = id;
        this.categoryId = categoryId;
        this.name = name;
        this.description = description;
