...
public class OrderTable implements Serializable {
     ...
     * @mbg.generated Sat Jun 17 22:59:18 CST 2023
     */
    public OrderTable(Long id, Long userId, BigDecimal totalPrice, Long addressId, String expressCompany, String expressId, String status, Date createdAt, Date updatedAt, Long shopId) {
        this.id = id;
        this.userId = userId;
